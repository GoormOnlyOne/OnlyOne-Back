...
import com.example.onlyone.domain.notification.service.NotificationRedisSubscriber;
...
public class RedisConfig {
    ...
    public RedisTemplate<String, Object> redisTemplate(
        ...
        org.springframework.data.redis.serializer.Jackson2JsonRedisSerializer<Object> serializer =
                new org.springframework.data.redis.serializer.Jackson2JsonRedisSerializer<>(redisObjectMapper, Object.class);
    ...
    public RedisMessageListenerContainer redisMessageListenerContainer(
        ...
        container.addMessageListener(notificationSubscriber,
            new PatternTopic("notification:events"));

        log.info("Redis Pub/Sub 구독 등록: chat.room.*, notification:events");
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory, ObjectMapper redisObjectMapper) {
        ...
        var cacheConfigurations = new java.util.HashMap<String, RedisCacheConfiguration>();
        cacheConfigurations.put("notificationList", defaultConfig.entryTtl(Duration.ofSeconds(5)));
        cacheConfigurations.put("unreadCount", defaultConfig.entryTtl(Duration.ofSeconds(10)));

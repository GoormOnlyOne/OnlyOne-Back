...
public enum ErrorCode {
    ...
    SSE_CONNECTION_TIMEOUT(408, "NOTIFY_408_1", "SSE 연결이 타임아웃되었습니다."),
    ...
    FCM_SEND_FAILED(502, "NOTIFY_502_2", "FCM 전송에 실패했습니다."),
    FCM_BATCH_SEND_PARTIAL_FAILURE(207, "NOTIFY_207_1", "FCM 배치 전송이 부분적으로 실패했습니다."),
    ...
    FCM_RATE_LIMIT_EXCEEDED(429, "NOTIFY_429_2", "FCM 전송 속도 제한을 초과했습니다."),
    ...
    // Notification 추가 예외 - 실제 테스트 시나리오용
    INVALID_NOTIFICATION_DATA(400, "NOTIFY_400_2", "알림 데이터가 유효하지 않습니다."),
    INVALID_PAGINATION_CURSOR(400, "NOTIFY_400_3", "페이지네이션 커서가 유효하지 않습니다."),
    TOO_MANY_NOTIFICATIONS(429, "NOTIFY_429_3", "알림 개수 한도를 초과했습니다."),
    NOTIFICATION_CONTENT_TOO_LONG(400, "NOTIFY_400_4", "알림 내용이 너무 깁니다."),
    DUPLICATE_NOTIFICATION(409, "NOTIFY_409_2", "중복된 알림입니다."),
    NOTIFICATION_EXPIRED(410, "NOTIFY_410_1", "만료된 알림입니다."),
